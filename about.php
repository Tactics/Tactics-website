    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-1 text-center">
          <h4 class="gray">Ons team versterken?</h4>
          <p>Heb je interesse in een geweldige job als PHP Developer en wil jij ons team aanvullen? Aarzel dan niet en stuur je CV en motivatiebrief naar <a href="mailto:info@tactics.be">info@tactics.be</a>.</p>
        </div>
      </div>
    </div>
  </section>
