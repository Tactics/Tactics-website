...
<section id="orange-container">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <p class="white">
                    Voor de stad Oostende ontwikkelden we een centraal aanmeldingsregister voor alle opvangvragen voor
...
<section id="content">
    <div class="container">
        <div class="bxslider">
            <div><img src="img/Oostende_1.jpg"></div>
            <div><img src="img/Oostende_2.jpg"></div>
            <div><img src="img/Oostende_3.jpg"></div>
        </div>
        <div class="row">
            <div class="col-md-10">
                <div class="col-md-10">
